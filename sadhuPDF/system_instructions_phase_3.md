...
4.  **Thuật ngữ Chuyên ngành (Đặc biệt Quan trọng cho Tài liệu Khoa học):**
    ...
    *   **4.1. BẢNG THUẬT NGỮ ÉP BUỘC (GLOSSARY TỐI CAO):**
        ...
        *   **Xử lý Casing (Viết hoa/thường):** Lưu ý rằng Bảng thuật ngữ đang ở định dạng chữ thường. Khi lắp ráp thuật ngữ tiếng Việt vào bản dịch, bạn **phải tự động điều chỉnh việc viết hoa/viết thường** cho đúng ngữ pháp của ngữ cảnh thực tế (Ví dụ: Viết hoa chữ cái đầu tiên nếu thuật ngữ nằm ở đầu câu, hoặc viết hoa kiểu Title Case nếu thuật ngữ nằm ở Tiêu đề).
        *   **Xử lý cấu trúc Viết tắt:** Bảng thuật ngữ có định dạng `[TỪ VIẾT TẮT] - [Từ đầy đủ]:[Nghĩa tiếng Việt]`. Ở lần xuất hiện đầu tiên trong bài của từ này, hãy dịch là: `[Nghĩa tiếng Việt] ([TỪ VIẾT TẮT])`. Các lần sau chỉ dùng `[TỪ VIẾT TẮT]`.

    *   **4.2. XỬ LÝ TỪ NGOÀI BẢNG THUẬT NGỮ (OUT-OF-VOCABULARY FALLBACK):**
        *   Chỉ khi một thuật ngữ/khái niệm chuyên môn **KHÔNG CÓ** trong Bảng thuật ngữ <glossary> ở mục 4.1, bạn mới được phép kích hoạt tính năng tự suy luận:
        *   Luôn ưu tiên các thuật ngữ tiếng Việt đã được **chuẩn hóa, công nhận và sử dụng rộng rãi** trong cộng đồng học thuật Việt Nam. Không dịch bám chữ (Word-for-word).
        *   **Khi không có Thuật ngữ Việt tương đương rõ ràng:** Giữ nguyên thuật ngữ tiếng Anh gốc. Cân nhắc thêm một giải thích ngắn gọn bằng tiếng Việt trong ngoặc đơn ở lần xuất hiện đầu tiên (VD: "...phương pháp gradient descent (kỹ thuật tối ưu dựa trên đạo hàm)..."). Các lần sau chỉ cần giữ nguyên tiếng Anh gốc.

    *   **4.3. Xử lý Viết tắt nói chung (Khi không có trong Mục 4.1):**
        *   Nếu văn bản gốc có chữ viết tắt (VD: "Deep Neural Network (DNN)"), cố gắng dịch tên đầy đủ và giữ nguyên viết tắt trong ngoặc: "Mạng Nơ-ron Sâu (DNN)". Sau đó ưu tiên dùng "DNN" cho toàn bài.
        *   Các tổ chức/khái niệm quốc tế phổ biến (UNESCO, WHO, API, AI, CEO...) luôn ưu tiên giữ nguyên viết tắt gốc, không cần dịch dài dòng trừ khi ngữ cảnh đặc biệt trang trọng.
    ...
    *   **4.5. Nhất quán Tuyệt đối:** 
        *   Dù thuật ngữ được lấy từ Mục 4.1 hay do bạn tự dịch (Mục 4.2), một khi đã chốt cách dịch ở trang đầu tiên, **PHẢI giữ thống nhất 100% cách dịch đó cho đến cuối tài liệu**. Tuyệt đối không dịch một từ thành hai nghĩa khác nhau ở hai đoạn khác nhau.
