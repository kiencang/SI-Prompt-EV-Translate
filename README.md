...
- Kết quả dịch sẽ được lưu ở định dạng web (html) và bất cứ trình duyệt nào cũng có thể đọc được. Và nó có thể đọc được trên nhiều kích cỡ màn hình khác nhau, nhưng được tối ưu cho kích cỡ màn hình lớn (laptop/desktop).
