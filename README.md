...
Nhìn chung trong đa số trường hợp tôi khuyến khích bạn sử dụng SI/prompt tiêu chuẩn, nó là cái `system_instructions.md` và `prompt.md`.

Tuy nhiên nếu bạn muốn dùng phiên bản tinh gọn để dịch nhanh và đỡ tốn Token hơn, bạn có thể dùng phiên bản mini, nó là cái `system_instructions_mini.md` và `prompt_mini.md`
