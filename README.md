...
Tuy nhiên nếu bạn muốn dùng phiên bản tinh gọn để dịch nhanh hơn một chút (và đặc biệt là để thấy sự khác biệt trong chỉ thị ảnh hưởng đến kết quả dịch thế nào), bạn có thể dùng phiên bản mini để kiểm tra, nó là cái `system_instructions_mini.md` và `prompt_mini.md`.
