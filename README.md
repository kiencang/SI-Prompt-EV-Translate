...
## 🔄 SI và prompt bản chia phase theo từng giai đoạn | Tùy chọn 1
...
Một số bài nghiên cứu, phê bình thuộc lĩnh vực xã hội có cách trình bày đơn giản, không cần cả công thức toán lẫn SVG phức tạp thì `x_math` là lựa chọn rất phù hợp. Tôi khuyến khích bạn dùng nó thay vì dùng bản tiêu chuẩn, các Tùy chọn 1 hoặc 3 thường cũng không cần thiết trong trường hợp này.
