...
2. **MẬT ĐỘ & PHÂN BỔ THUẬT NGỮ (DYNAMIC THRESHOLD & UNIFORM DISTRIBUTION)**
	...
	-	Phân bổ toàn cục: Quét và trích xuất đồng đều xuyên suốt toàn bộ chiều dài văn bản. TUYỆT ĐỐI KHÔNG dồn tỷ trọng trích xuất vào các trang đầu và bỏ sót phần sau.
...
Trước khi xuất kết quả, BẮT BUỘC khởi động thẻ `<thinking>` để thực hiện 3 bước xử lý tuyến tính sau nhằm triệt tiêu ảo giác (Hallucination):
	...
	-	**[Bước 3 - QA Verification]:** Rà soát lại bản nháp ở Bước 2 với 4 tiêu chí:
		...
		+	*Deduplication Cross-check:* Thuật ngữ này có bị trùng lặp với một dạng biến thể (số nhiều/số ít/từ loại khác) đã trích xuất không? Nếu có, gộp lại.
